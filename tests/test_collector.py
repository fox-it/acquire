...
def test_collector_collect_path_with_file(
    ...
    with (
        ...
        assert mock_log.info.call_args.args == ("- Collecting path %s succeeded", path)
...
def test_collector_collect_path_dedup_symlink_branch(mock_target: Target, mock_collector: Collector) -> None:
    ...
    with (
        ...
        assert mock_log.info.call_args.args == ("- Collecting path %s succeeded", collect_path)
...
def test_collector_collect_path_with_symlink(
    ...
    with (
        ...
        assert mock_log.info.call_args.args == ("- Collecting path %s succeeded", symlink_path)
